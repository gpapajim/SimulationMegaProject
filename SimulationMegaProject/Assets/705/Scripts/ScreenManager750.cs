...
public class ScreenManager750 : MonoBehaviour
{
    public ModeManager750 modeManager;
    public LightManager750 lightManager;
    public Bottle750 bottleS;
    [Header("Visual")]
    ...
    public void Update()
    {
        ...
        {
            normalMode.GetComponent<TextMeshProUGUI>().text = f1New.ToString("0.0");
        }*/
        ...
        if(modeManager.inMode == false && modeManager.inMode2==false && modeManager.inMode3==false && !modeManager.alarmTesting)
        {
            gas = 0;
        }
        ...
        if(modeManager.zero==true && modeManager.inMode3==true)
        {
            zero.SetActive(false);
            span.SetActive(false);
            ouT.SetActive(false);
        ...
        ///////////////////////////////////////////// closing           test for fixing testModechange condition to ignore testMode
