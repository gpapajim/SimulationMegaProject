...
public class ButtonPressSD10X : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        /////////////////////////////////+-10 timer
        if ((maintenance.gasInDone || maintenance.gasIn || maintenance.inMode4h ||(maintenance.menuSelector2==2 && maintenance.inMode2 && maintenance.fix22)) && up)
        {
        ...
        if ((maintenance.gasInDone || maintenance.gasIn || maintenance.inMode4h || (maintenance.menuSelector2 == 2 && maintenance.inMode2 && maintenance.fix22)) && down)
        {
            plusTimer -= Time.deltaTime;
            plusFastTimer -= Time.deltaTime;
        }
    ...
    public void Up()
    {
        ...
        if (maintenance.menuSelector2 ==2 && maintenance.inMode2 && maintenance.fix22)
        {
            screen.C4H10.Value += 1;
        }
    ...
    public void Set()
    {
        ...
        if (maintenance.menuSelector2 == 2 && maintenance.inMode2)
        {
            screen.blinkingScreen = true;
            maintenance.fix22 = true;
        }

        if (maintenance.fix22 && (screen.C4H10.Value < 211 && screen.C4H10.Value > 207))
        {
            maintenance.fix22 = false;
            maintenance.inCalZero = true;
            screen.dataObj.SetActive(false);
            screen.dot.DotsControl(false, false, false, false);
            screen.blinkingScreen = false;
            maintenance.calTimer = 2.5f;
            error.error1 = false;
        }
        ...
        if (maintenance.gasInDone && (screen.C4H10.Value < 5 && screen.C4H10.Value >-1))
        {
            maintenance.ClearScreen();
            maintenance.inCalZero = true;    
        }*/
    ...
    public void MenuNo()
    {
        ...
        if (mode.maintenanceMode2)
        {
            if (maintenance.inMode2)
            {
                ...
                maintenance.fix22 = false; // fixed in 2.03
                screen.blinkingScreen = false;
                screen.bottleC4H10.SetActive(false);
       ...
       /* if (mode.maintenanceMode2 && maintenance.inMode2 && (maintenance.gasIn || maintenance.gasInDone))
        {
            maintenance.gasIn = false;
            maintenance.gasInDone = false;
            screen.blinkingScreen = false;
